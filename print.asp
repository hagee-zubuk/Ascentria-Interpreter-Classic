...
If Not rsConfirm.EOF Then
	...
	'tmpName = rsconfirm("cfname") 'rsConfirm("clname") & ", " & rsConfirm("cfname")
...
If Request("PDF") = 1 Then
	If Z_Czero(tmpIntr) <> Z_Czero(Request("IDIntr")) Then 
		Call SaveHist(Request("ID"), "[interpreter]print.asp(" & tmpIntr & "<>" & Request("IDIntr") & ")")
		'tmpIntr = Z_Czero(Request("IDIntr"))
	End If
End If
          ...
          <tr>
                    ...
                    <p class="header">
				        ...
				        <tr>
				        	<td>
				        		<p class="header">
				        			Name:<u><b><%=tmpInName%></b></u>________
				        		</p>
				        	</td>
				        </tr>
				        <tr><td>&nbsp;</td></tr>
