...
If Not rsLangIntr.EOF Then
	...
	Do Until rsIntrLang.EOF
		If isNull(rsIntrLang("vacfrom")) Then
		...
		strIntr = strIntr	& "<option " & IntrSel & " value='" & rsIntrLang("Index") & "'>" & rsIntrLang("last name") & ", " & rsIntrLang("first name") & "</option>" & vbCrlf
		tmpIntrName = CleanMe(rsIntrLang("last name")) & ", " & CleanMe(rsIntrLang("first name"))
		strIntr2 = strIntr2 & "{var ChoiceReq = document.createElement('option');" & vbCrLf & _
	...
	strJScript2 = strJScript2 & "if (Intr == " & rsIntrLang("Index") & ") " & vbCrLf & _
		"{document.frmAssign.selIntr.value = """ & rsIntrLang("Index") &"""; " & vbCrLf & _
		...
		"document.frmAssign.txtIntrRate.value = """ & rsIntrLang("Rate") &"""; " & vbCrLf & _
		"document.frmAssign.LangCtr.value = " & CtrLang &"; " & vbCrLf & _
		...
		"document.frmAssign.Lang5.value = GetLangID(""" & Trim(rsIntrLang("Language5")) &"""); " & vbCrLf 
	...
	If IsActive(tmpIntr) = False Then
		...
		If Not rsIntr.EOF Then
			...
			strJScript2 = strJScript2 & "if (Intr == " & rsIntr("Index") & ") " & vbCrLf & _
				...
				"document.frmAssign.txtIntrRate.value = """ & rsIntr("Rate") &"""; " & vbCrLf & _
				"document.frmAssign.LangCtr.value = " & CtrLang &"; " & vbCrLf & _
				...
				"document.frmAssign.Lang5.value = GetLangID(""" & Trim(rsIntr("Language5")) &"""); " & vbCrLf 
...
<html>
	<head>
		...
		function EditMe()
		{
			document.frmAssign.action = "main.asp?ID=" + <%=Request("ID")%>;
			document.frmAssign.submit();
		}
		function EditMe2()
		{
			document.frmAssign.action = "mainbill.asp?ID=" + <%=Request("ID")%>;
			document.frmAssign.submit();
		}
		...
		{
			if (document.frmAssign.selIntr.value !== "-1")
			{
		...
		<body onload='IntrInfo(<%=tmpIntr%>); hideNewIntr();LangChoice(<%=tmpLang%>, <%=tmpIntr%>);'>
								...
								<tr>
									...
									<tr>
										...
										<td>
											...
											<!--<input type='checkbox' name='chkAll2' onclick='IntrShowMe(); IntrInfo(document.frmAssign.selIntr.value);'>
											Show All//-->
