...
Function CheckApp2(tmpdate)
	...
	sqlReq = "SELECT * FROM request_T WHERE appDate = '" & tmpDate & "' AND InstID = 93 ORDER BY appTimeFrom"
...
<html>
	<head>
		...
		{
			document.frmCal.action = "calSNHMC.asp?selMonth=" + xm + "&txtday=" + xd + "&txtyear=" + xy;
			document.frmCal.submit();
		}
		function PublishMe()
		{
