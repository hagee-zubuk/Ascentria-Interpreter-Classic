							...
							<table cellSpacing='0' cellPadding='0' width="100%" border='0'>
								...
								<% If Cint(Request.Cookies("LBUSERTYPE")) = 4 Then %>
										<tr><td>&nbsp;<input type='hidden' name='txtInstZip' value='<%=tmpZipInst%>'>
											...
											<input type='hidden' name='txtTravel'></td></tr>
										<tr><td>&nbsp;</td></tr>
								...
								<% Else %>
									<tr>
										<td colspan='10' align='center' height='100px' valign='bottom'>
											<input class='btn' type='button' style='width: 509px;' <%=TTM%> value='Save Travel Time and Mileage' onmouseover="this.className='hovbtn'" onmouseout="this.className='btn'" onclick="SaveTTM('<%=Request("ID")%>');">
										</td>
									</tr>
									<tr>
