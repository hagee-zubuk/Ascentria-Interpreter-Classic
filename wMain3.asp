...
'If Request("show") <> 1 Then
	...
	sqlReqI = "SELECT requester_T.[Index] as myindex, Phone, pExt, Fax, Email, prime, lname, fname FROM requester_T, reqdept_T WHERE DeptID = " & tmpDept & " AND ReqID = requester_T.[index] ORDER BY Lname, Fname"
